...
export const Train = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    ...
    className="icon icon-tabler icons-tabler-outline icon-tabler-train"
    {...props}
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export const FishCristianity = ({
  ...
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    className="icon icon-tabler icons-tabler-outline icon-tabler-fish-christianity"
    {...props}
  >
    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export const Download = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size || width}
    height={size || height}
...
export const SendMailPack = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size || width}
    height={size || height}
